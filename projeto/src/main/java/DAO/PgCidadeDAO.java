...
public class PgCidadeDAO implements CidadeDAO{
    ...
    private static final String CREATE_CIDADE = "INSERT INTO local_names_db.cidade(id_cidade, nome_cidade, estado)" + "VALUES (?,?,?)";
    private static final String GET_CIDADE = "SELECT * FROM local_names_db.cidade  WHERE id_cidade = ?";
    private static final String GET_ALL_CIDADES = "SELECT * FROM local_names_db.cidade";
    private static final String UPDATE_CIDADE = "UPDATE * FROM local_names_db.cidade SET nome_cidade=?, estado=? WHERE id_cidade = ?";
    private static final String DELETE_CIDADE = "DELETE * FROM local_names_db.cidade  WHERE id_cidade = ?";
